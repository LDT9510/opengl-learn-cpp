...
# Compiler frontends
string(COMPARE EQUAL "GNU" "${CMAKE_C_COMPILER_FRONTEND_VARIANT}" C_COMPILER_IS_GNU_LIKE)
string(COMPARE EQUAL "MSVC" "${CMAKE_C_COMPILER_FRONTEND_VARIANT}" C_COMPILER_IS_MSVC_LIKE)
...
# Specific compilers
string(COMPARE EQUAL "Clang" "${CMAKE_C_COMPILER_ID}" C_COMPILER_IS_CLANG)
string(COMPARE EQUAL "GNU" "${CMAKE_C_COMPILER_ID}" C_COMPILER_IS_GCC)
string(COMPARE EQUAL "MSVC" "${CMAKE_C_COMPILER_ID}" C_COMPILER_IS_MSVC)
string(COMPARE EQUAL "Clang" "${CMAKE_CXX_COMPILER_ID}" CXX_COMPILER_IS_CLANG)
string(COMPARE EQUAL "GNU" "${CMAKE_CXX_COMPILER_ID}" CXX_COMPILER_IS_GCC)
