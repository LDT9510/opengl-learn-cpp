...
block()
    ...
    # for Emscripten, always build static
    if(EMSCRIPTEN)
        ForceBool(SDL_SHARED OFF)
        ForceBool(SDL_STATIC ON)
    endif ()

    # force_bool(SDL_ALSA OFF)  # Support the ALSA audio API (should be conditional)
    ...
    ForceBool(SDL_AUDIO ON)  # Enable the Audio subsystem
    ...
    ForceBool(SDL_HAPTIC ON)  # Enable the Haptic subsystem
    ...
    ForceBool(SDL_POWER ON)  # Enable the Power subsystem
    ...
    ForceBool(SDL_SENSOR ON)  # Enable the Sensor subsystem
    ...
    # force_bool(SDL_X11 OFF)  # Use X11 video driver (should be conditional)
